...
def start():
   ...
   random_index0 = random.randint(0, 6)
   random_index1 = random.randint(0, 6)
   tetromino_num = [random_index0, random_index1]
   current_tetromino = create_tetromino(grid_h, grid_w, tetromino_num[0])
   next_tetromino = create_tetromino(14, 14, tetromino_num[1])
   ...
   stop_checker = 0
   pygame.mixer.init()
   drop_sound = pygame.mixer.Sound("fall.wav")
   pause_count = 0
   main_music=pygame.mixer.music.load("tetris-gameboy-02.mp3")
   ...
   while True:
      ...
      if not success:
         ...
         tetromino_num[0] = tetromino_num[1]
         random_index3 = random.randint(0, 6)
         tetromino_num[1] = random_index3
         current_tetromino = create_tetromino(grid_h, grid_w, tetromino_num[0])
         grid.current_tetromino = current_tetromino
         next_tetromino = create_tetromino(14, 14, tetromino_num[1])
         grid.next_tetromino = next_tetromino
   ...
   img_file = current_dir + "/game_over_PNG57.png"
...
def create_tetromino(grid_height, grid_width, tetromino_num):
   # type (shape) of the tetromino is determined randomly
   tetromino_types = ['I', 'O', 'Z', 'S', 'T', 'L', 'J']
   random_type = tetromino_types[tetromino_num]
...
def display_game_menu(grid_height, grid_width):
   ...
   stddraw.setFontFamily("Press Start 2P")
